...
The recent introduction of LLMs has drawn significant attention
...
summary, and computer programming.
...
%science education. 
This paper aims to explore how well LLMs can perform in an
introductory-level functional language programming course.  Our comprehensive evaluation provides valuable
insights into LLMs' impact from both student and instructor
perspectives. Additionally, we identify several potential benefits
that LLMs can offer to both groups. Overall, we believe that this
study significantly clarifies and advances our understanding of
LLMs' capabilities and potential impact on computer science education.
\end{abstract}
